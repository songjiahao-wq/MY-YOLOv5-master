...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        CTR3, C3STR, C3_DCNv2, CoordConv, CSPStage}:#添加模块
            c1, c2 = ch[f], args[0]
            ...
            if m in {BottleneckCSP, C3, C3TR,CTR3, C3Ghost, C3x,
                     C3CA, C3ECA, C3CAAM, C3STR, C3_DCNv2, CSPStage}:#添加模块
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default=r'yolov5s-Improved/yolov5s.GFPN.yaml', help='model.yaml')
